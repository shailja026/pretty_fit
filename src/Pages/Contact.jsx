        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <p className="text-[16px] w-[95%] text-[#646464] font-medium my-[40px]">
              At GymTrac, we are dedicated to helping you achieve the body of
          ...
          {/* second col ---*/}
          <form onSubmit={handleSubmit} className="flex flex-col pt-[30px] pr-[50px] pb-[50px] pl-[45px] bg-[#f8f8f8] relative md1000:w-[65%] md1000:flex md1000:flex-col md1000:mx-auto md1000:mt-14 min800:w-[90%] min620:w-full">
            ...
            ></input>
            <select value={userDetails.classes} onChange={(e)=>setUserDetails({...userDetails,classes:e.target.value})} className="w-full py-[12px] px-[20px] h-[51px] text-[14px] border border-solid border-[#e4e4e4] outline-none mb-8">
